...
import { setCreateState, getAllClients } from '../../actions/createInterview/createInterview.actions';
...
export interface ICreateInterviewComponentProps extends RouteComponentProps {
    ...
    getAllClient: (event) => void;
}

export class CreateInterviewComponent extends React.Component<ICreateInterviewComponentProps> {
    componentDidMount() {
    ...
    getAllClients = async () => {
        ...
        console.log('All Clients: ' + this.props.createInterviewComponentState.clientArr);
    }
    ...
    render() {
        ...
        console.log('All Clients: ' + allCohorts);
        ...
        return (
            <div id='new-interview-full'>
                ...
                <div className="row">
                    ...
                    <Button color="secondary" size="lg" block disabled={buttonDisabledState} onClick={this.buttonOnClick}>{buttonText}</Button>
                </Form>
            </div>
        );
    }
